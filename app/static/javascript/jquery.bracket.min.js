        ...
        function mkMatch(round, data, idx, results, renderCb) {
            ...
            function teamElement(round, team, isReady) {
                ...
                if (!team.name || !isReady) {
                    ...
                    if (!isNumber(team.score) || team.score == -1) {
                        score = '--';
                    } else {
                        score = team.score;
                    }
                ...
                if (team1 && team2)
                {
                    ...
                    getresult(getParameterByName('id'),rId,team1,team2,setEventIdTag);
                    team1 = "";team2="";
                }
                ...
                if (!(team.name === null || !isReady || !opts.save) && opts.save) {
                    ...
                    var matchUserData = tempData
                    onclickbracket(matchUserData,rId);
                        ...
                        sEl.click(function () {
                            ...
                            function editor() {
                                ...
                                input.blur(function () {
                                    ...
                                    getEventIdOfResult(getParameterByName('id'),rId,function(data)
                                    {
                                        eventIDOfResult = data;

                                    });

                                    setscore(eventIDOfResult,rId,val);
            ...
            if (!opts.save) {
                ...
                if (opts.onMatchClick)
                    teamCon.click(function () {
                        onclickbracket(matchUserData,matchUserData[0]['idx']);
                    });
            }
